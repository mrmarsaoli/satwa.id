...
--
-- Host: 127.0.0.1
-- Generation Time: 15 Jan 2017 pada 15.30
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
--
ALTER TABLE `pesan_tiket`
  MODIFY `id_pesan_tiket` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `event`
  ...
  ADD CONSTRAINT `event_ibfk_5` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `hewan`
  ...
  ADD CONSTRAINT `hewan_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `trans_beli`
  ...
  ADD CONSTRAINT `trans_beli_ibfk_3` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
